      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1 min-w-0">
          ...
          {streamUrl && !streamError ? (
            ...
            {/* Ad blocker tip */}
            <div className="mt-2 flex items-center gap-2 px-3 py-2 rounded-lg bg-surface/50 border border-border text-xs text-muted">
              ...
              <p>Tip: Install <a href="https://ublockorigin.com/" target="_blank" rel="noopener noreferrer" className="text-secondary hover:underline">uBlock Origin</a> to block ad redirects while watching.</p>
            </div>
          ) : (
